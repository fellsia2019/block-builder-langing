        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <AnimateOnScroll animationName="SCALE_UP" animationDelay={200}>
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden hover:shadow-3xl transition-shadow">
              <div className="bg-gradient-to-r from-primary-600 to-purple-600 px-6 py-4">
                <h3 className="text-xl font-semibold text-white">{t('installTitle')}</h3>
              </div>
              <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {(['1', '2', '3'] as const).map((step, index) => (
              <AnimateOnScroll
                key={step}
                animationName={index === 0 ? 'FADE_IN_LEFT' : index === 1 ? 'FADE_IN_UP' : 'FADE_IN_RIGHT'}
              ...
              >
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 hover:shadow-xl hover:scale-105 transition-all">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">{t(`steps.${step}.description`)}</p>
                </div>
              </AnimateOnScroll>
            ))}
          </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white">{t('resources.docs.title')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{t('resources.docs.description')}</div>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white">{t('resources.github.title')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{t('resources.github.description')}</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white">{t('resources.demo.title')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{t('resources.demo.description')}</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white">{t('resources.ssr.title')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{t('resources.ssr.description')}</div>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-gray-900 dark:text-white">{t('resources.support.title')}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">{t('resources.support.description')}</div>
                  </div>
                </a>
              </div>
            </div>
