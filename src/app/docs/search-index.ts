...
export const DOCS_SEARCH_INDEX: DocsSearchEntry[] = [
  ...SIDEBAR_ENTRIES,
  { title: 'BlockBuilderComponent', href: '/docs/vue/components', group: 'Vue 3', keywords: 'свойства события компонент' },
  { title: 'BlockBuilderComponent', href: '/docs/react/components', group: 'React', keywords: 'свойства колбэки компонент' },
